...
#' Condition GF upregulation, condition GF downregulation, condition SPF upregulation, condition SPF downregulation
#'
...
analyseATACseqComp = function(metadataFileName,countsFileName,reference){
